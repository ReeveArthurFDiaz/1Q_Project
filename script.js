document.addEventListener("DOMContentLoaded", () => {
    ...
    function validateAndStore(event) {
      event.preventDefault();
      let isValid = true;
      const fields = ["fname", "lname", "email", "password", "support"];
      fields.forEach(id => {
      ...
      if (isValid) {
        ...
        localStorage.setItem("support", document.getElementById("support").value);
        window.location.href = "proj_profile_DIAZ.html";
      }
    }
    ...
    window.onload = function() {
      ...
      document.getElementById("support").textContent = localStorage.getItem("support");
    }
